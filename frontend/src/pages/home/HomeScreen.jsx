...
const HomeScreen = () => {
  ...
  return (
    ...
    <div  className='relative h-screen text-white'>
      <Navbar/>
      <img src="/extraction.jpg" alt="image" className='absolute top-0 left-0 w-full h-full object-cover -z-50'/>
      ...
      <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
        <div className='bg-gradient-to-b from-black via-transparent to-transparent absolute w-full h-full top-0 left-0 -z-10 '/>
            <div className='max-w-2xl'>
              ...
              <p className='mt-4 text-lg'>Chris Hemsworth stars in this nonstop action thriller with rudrakash jaiswal,Randeep Hooda and Golsifteh Farahani</p>
        </div>
