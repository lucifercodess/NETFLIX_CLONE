...
import { LARGE_IMAGE_URL, MOVIE_CATEGORIES, TV_CATEGORIES } from '../../utils/contants/Constant'
...
if(!trendingContent){
  ...
  return (
    ...
    <div  className='relative h-screen text-white'>
      <Navbar/>
      <img src={LARGE_IMAGE_URL + trendingContent?.backdrop_path} alt="image" className='absolute top-0 left-0 w-full h-full object-cover -z-50'/>
      ...
      <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
        <div className='bg-gradient-to-b from-black via-transparent to-transparent absolute w-full h-full top-0 left-0 -z-10 '/>
            <div className='max-w-2xl'>
              ...
              <p className='mt-2 text-xl'>{trendingContent?.release_date?.split('-')[0] || trendingContent?.first_air_date.split("-")[0]}{" "} |  
